    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-20 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Chatea con tus <span className="text-blue-600">Documentos</span> en
          segundos
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          QuillUleam le permite tener conversaciones con cualquier documento
          PDF. simplemente sube tu archivo y comienza a hacer preguntas de
          inmediato.
        </p>
        <Link
              ...
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4 ">
                  <Image
                    ...
                    alt="prvisaualizacion de producto "
                    width={1364}
                    height={866}
                    quality={100}
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
              Empieza a chatear en munitos
            </h2>
            <p className="mt-4 text-lg text-gray-600">
              Chatear con tus archivos PDF nunca ha sido tan fácil como con
              QuillUleam.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="text-xl font-semibold">Sube tu archivo PDF</span>
              <span className="mt-2 text-zinc-700">
                Procesarás tu archivo y lo prepararás para poder chatear con él.
              </span>
            </div>
          </li>
          <li className="md:flex-1">
